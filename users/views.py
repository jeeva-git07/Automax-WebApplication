...
def login_view(request):
    if request.method=='POST':
        ...
        if login_form.is_valid():
             ...
             messages.error(request,f"An error occured when trying to loggin")
...
class ProfileView(View):
     ...
     def get(self,request):
           ...
           return render(request,"views/profile.html",{"user_form":user_form,"location_form":location_form,"profile_form":profile_form,"user_listings":user_listings,"user_liked_listings":user_liked_listings})
     ...
     def post(self,request):
          ...
          if user_form.is_valid() and location_form.is_valid() and profile_form.is_valid():
               ...
               location_form.save()
               profile_form.save()
               messages.error(request,"PROFILE IS UPDATED SUCCESSFULLY!")
          else:
